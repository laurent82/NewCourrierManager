...
CDrawPanel::CDrawPanel(int _width, int _height, QWidget* parent):QFrame(parent)
{
...
void CDrawPanel::setPanelSize (int _w, int _h){
    m_width = _w;
    m_height = _h;
...
bool CDrawPanel::setFile(QString strFileName){
...
void CDrawPanel::paintEvent(QPaintEvent *event){
...
void CDrawPanel::drawZoom(QPainter* painter){
...
void CDrawPanel::mouseMoveEvent( QMouseEvent * event ){
...
void CDrawPanel::mousePressEvent( QMouseEvent * event ){
    // if (m_drawZoomMove
}
